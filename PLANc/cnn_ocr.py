...
FLAGS = util_p.FLAGS
num_classes = util_p.num_classes
...
class LSTMOCR(object):
    ...
    def _build_model(self):
        ...
        with tf.variable_scope('lstm'):
            ...
            outputs=tf.reshape(outputs,(FLAGS.batch_size,128*256))

            #outputs = tf.transpose(outputs, (1, 0, 2))

            W = tf.get_variable(name='W',
                                shape=[FLAGS.num_hidden*256, num_classes],
                                dtype=tf.float32,
    ...
    def _max_pool(self, x, ksize, strides, strides_t):
        return tf.nn.max_pool(x,
                              ksize=[1, ksize, ksize, 1],
                              strides=[1, strides, strides_t, 1],
                              padding='SAME',
                              name='max_pool')
