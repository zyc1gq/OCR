...
tf.app.flags.DEFINE_integer('save_steps', 840, 'the step to save checkpoint')
tf.app.flags.DEFINE_integer('validation_steps', 11, 'the step to validation')
...
tf.app.flags.DEFINE_integer('decay_steps', 840*2, 'the lr decay_step for optimizer')
